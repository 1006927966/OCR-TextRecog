...
from utils.tools import loadkeyfile, create_module, makedir, averager, save_checkpoint, randomChoice, tensor2img, \
...
def Val(model, val_loaders, criterion, config):
    ...
    for data_name, val_loader in zip(val_data_names, val_loaders):
        ...
        print('data:{} n_correct:{} data_num:{} data_total:{} wordAcc:{}'.format(data_name, n_correct, data_num,
                                                                                 val_datanum_dict[data_name], wordAcc))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default="/code/wujilong/code/OCR-TextRecog/config/SVTR-T-Ch-stn.yaml", help='DDP parameter, do not modify')
